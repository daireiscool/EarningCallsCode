...
###############################################
    ...
    def getVerdict(self, score):
        if score < self.threshold:
            ...
            return "Unknown how this text is written."
        else:
    ...
    def getScore(self, sentence):
        ...
        remaining = 50
        sentences = self.mask(original_sentence, original_sentence, n=20, remaining=remaining)
    ...
    def call_1_1(self, sentence, chunk_value):
        ...
        for line in lines:
            ...
            elif score == -1 or math.isnan(score):
                labels.append(-1)
                prob = "{:.2f}%\n(Unknown)".format(normCdf(abs(self.threshold - score)) * 100)
                probs.append(prob)
                probs.append(prob)
            else:
                labels.append(1)
        ...
        return label, diff, mean_score, mean_prob, self.getVerdict(mean_score)
